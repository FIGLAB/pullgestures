...
public class ScreenTouch_Stand : MonoBehaviour
{
    ...
    void Update () {
        ...
        if (num_touches > 0)
        {
            Debug.Log("NUM TOUCHES: " + num_touches);
            ...
            for (int i = 0; i < num_touches; i++)
            {
                ...
                temp_position = new Vector3((float)(-midwidth + pixwidth * touch.position.x), (float)(midheight + pixheight * touch.position.y), (float)(0.024 - (midheight + pixheight * touch.position.y) * Mathf.Cos(17)));
            ...
            if (touch.phase == TouchPhase.Began || touch.phase == TouchPhase.Moved) {
                temp_block.transform.localPosition = new Vector3((float)(-midwidth + pixwidth * touch.position.x), (float)(midheight + pixheight * touch.position.y), (float)(0.024 - (midheight + pixheight * touch.position.y) * Mathf.Cos(17)));
            } */
        }
	}
}
